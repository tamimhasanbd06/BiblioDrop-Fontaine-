...
// বাংলা মন্তব্য: User নিজের reviews edit/delete করতে পারে; list paginated।
export default function MyReviewsPage() {
  ...
  const load = async () => {
    try {
      setLoading(true);
      const data = await serverApi(`/dashboard/user/reviews?page=${page}&limit=12`);
